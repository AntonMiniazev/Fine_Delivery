...
df_assortment = pd.read_csv('https://raw.githubusercontent.com/AntonMiniazev/Fine_Delivery/main/project_notebooks/assortment_generator.csv', dtype=object, delimiter = ';', thousands=',')
df_delivery_types = pd.read_csv('https://raw.githubusercontent.com/AntonMiniazev/Fine_Delivery/main/initial_data/delivery_types.csv', dtype=object, delimiter = ';', thousands=',')
...
@dag(dag_id='dag_load_order_data_master', 
...
dag_load_order_data_master = load_order_data()